...
// Note: dotenv.config() is not needed on Vercel as environment variables are injected directly.
// cors is also handled via vercel.json or headers, typically not needed for same-origin API calls.
